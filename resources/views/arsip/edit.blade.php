                ...
                <main>
                    <div class="content">
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">Arsip Surat >> Lihat >> Edit/Ganti File</h1>
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item">
                                    Silahkan untuk mengganti/mengupdate file PDF!
                                </li>
                            </ol>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card card-primary card-outline">
                                        ...
                                        <div class="card-footer">
                                            <a href="{{ route ('show', $arsip->id_arsip) }}" class="btn btn-secondary"><i class="fas fa-angles-left"></i> Kembali</a>
